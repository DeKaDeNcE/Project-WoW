...
bool BattlegroundTP::SetupBattleground()
{
    ...
    if (!AddObject(BG_TP_OBJECT_A_FLAG, BG_OBJECT_A_FLAG_TP_ENTRY, 2118.210f, 191.621f, 44.052f, 5.741259f, 0, 0, 0.9996573f, 0.02617699f, BG_TP_FLAG_RESPAWN_TIME/1000)            // Cata
        ...
        // alliance gates
        || !AddObject(BG_TP_OBJECT_DOOR_A_1, BG_OBJECT_DOOR_A_1_TP_ENTRY, 2077.35f, 215.673f, 43.6498f, 1.04891f, 0, 0, 0, 0, RESPAWN_IMMEDIATELY)              // Cata
        || !AddObject(BG_TP_OBJECT_DOOR_A_2, BG_OBJECT_DOOR_A_2_TP_ENTRY, 2113.95f, 147.866f, 43.5045f, 4.17046f, 0, 0, 0, 0, RESPAWN_IMMEDIATELY)              // Cata
        || !AddObject(BG_TP_OBJECT_DOOR_A_3, BG_OBJECT_DOOR_A_3_TP_ENTRY, 2156.82f, 220.669f, 43.5242f, 5.77817f, 0, 0, 0, 0, RESPAWN_IMMEDIATELY)              // Cata
        // horde gates
        || !AddObject(BG_TP_OBJECT_DOOR_H_1, BG_OBJECT_DOOR_H_1_TP_ENTRY, 1621.06f, 339.727f, 1.3447f, 3.07324f, 0, 0, 0, 0, RESPAWN_IMMEDIATELY)
        || !AddObject(BG_TP_OBJECT_DOOR_H_2, BG_OBJECT_DOOR_H_2_TP_ENTRY, 1558.18f, 373.11f, 1.71029f, 6.18183f, 0, 0, 0, 0, RESPAWN_IMMEDIATELY)
        || !AddObject(BG_TP_OBJECT_DOOR_H_3, BG_OBJECT_DOOR_H_3_TP_ENTRY, 1556.64f, 314.501f, 1.22473f, 3.02769f, 0, 0, 0, 0, RESPAWN_IMMEDIATELY)
       )
    {
