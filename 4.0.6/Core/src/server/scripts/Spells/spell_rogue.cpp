        ...
        class spell_rog_preparation_SpellScript : public SpellScript
        {
            ...
            void HandleDummy(SpellEffIndex /*effIndex*/)
            {
                ...
                for (SpellCooldowns::const_iterator itr = cm.begin(); itr != cm.end();)
                {
                    ...
                    {
                        if (spellInfo->SpellFamilyFlags[1] & SPELLFAMILYFLAG1_ROGUE_SHADOWSTEP ||      // Cold Blood, Shadowstep
                            spellInfo->SpellFamilyFlags[0] & SPELLFAMILYFLAG_ROGUE_VAN_SPRINT)           // Vanish, Evasion, Sprint
