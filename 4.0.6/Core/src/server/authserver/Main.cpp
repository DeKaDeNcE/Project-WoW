...
char serviceLongName[] = "TrueBlood Auth service";
char serviceDescription[] = "TrueBlood World of Warcraft emulator world auth service";
/*
...
extern int main(int argc, char **argv)
{
    ...
    sLog->outString("    \\/_____/\\/_/\\/_/\\/_____/\\/_/   \\/_/\\/_/ /_/\\/_____/ ");
    sLog->outString("  TrueBlood 2012(c) ");
    sLog->outString("           <http://www.trueblood-servers.com/> ");
