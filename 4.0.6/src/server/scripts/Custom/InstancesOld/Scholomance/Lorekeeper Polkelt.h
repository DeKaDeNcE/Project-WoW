...
#define SPELL_VOLATILEINFECTION      18149
...
public:
    ...
    struct boss_lorekeeperpolkeltAI : public ScriptedAI
    {
        ...
        void Reset()
        {
            ...
            CorrosiveAcid_Timer = 5000;
            NoxiousCatalyst_Timer = 10000;
        }
        ...
        void UpdateAI(const uint32 diff)
        {
            ...
            if (VolatileInfection_Timer <= diff)
            {
                ...
                VolatileInfection_Timer = urand(20000, 32000);
