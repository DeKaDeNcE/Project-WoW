            ...
            case SPELLFAMILY_GENERIC:
            {
                ...
                switch(m_spellInfo->Id)                     // better way to check unknown
                {
                    ...
                    case 28865:
                        ...
                        break;
                    // Invocation d'une Gargouille (Summon Gargoyle)
                    case 49206: // Invocation d'une Gargouille
                    if (unitTarget)
                        m_caster->CastSpell(m_caster, 61777, false, NULL);
                    return;
                    // Ancient Fury
                    case 86704:
                    {
...
void Spell::EffectDummy(SpellEffIndex effIndex)
{
    ...
    switch (m_spellInfo->SpellFamilyName)
    {
        ...
        case SPELLFAMILY_DEATHKNIGHT:
            ...
            {
                int32 bp;
                if ((m_caster->CountPctFromMaxHealth(7)) > (15 * m_caster->GetDamageTakenInPastSecs(5) / 100)) bp = m_caster->CountPctFromMaxHealth(7);
                    else bp = (15 * m_caster->GetDamageTakenInPastSecs(5) / 100);
    ...
    switch (m_spellInfo->SpellFamilyName)
    {
        ...
        case SPELLFAMILY_DRUID:
        {
            ...
            if(m_spellInfo->Id == 80313) // Pulverize
            {
                ...
                {
                    int32 bp = ((2706 * 60 / 100) * lacer->GetStackAmount()) / 100;
    ...
    switch(m_spellInfo->SpellFamilyName)
    {
        case SPELLFAMILY_GENERIC:
        {
            switch(m_spellInfo->Id)
            {
                ...
                {
                    int32 basepoints0 = int32(m_caster->getLevel() * 3.00f);
