    ...
    switch(GetAuraType())
    {
        ...
        case SPELL_AURA_PERIODIC_ENERGIZE:
            ...
            else if (m_spellProto->Id == 29166)
            {
                ...
                {
                    if(GetBase()->GetCaster()->HasAura(33597))   // Dreamstats rank1
                        bonusMana += 15;
...
{
    ASSERT(caster);
    return caster->isSpellCrit(target, m_spellProto, GetSpellSchoolMask(m_spellProto));
}
          ...
          case 603: // Bane of Doom
          {
            ...
            if (GetAuraType() == SPELL_AURA_PERIODIC_DAMAGE)
            {
                ...
                if (GetSpellProto()->Id == 53301)
                    damage = int32(damage + (0.232f * GetBase()->GetCaster()->GetTotalAttackPowerValue(RANGED_ATTACK)) * 2);
