...
void SpellMgr::LoadSpellCustomAttr()
{
    ...
    for (uint32 i = 0; i < sSpellStore.GetNumRows(); ++i)
    {
        ...
        switch (i)
        {
        case 49206: // Invocation d'une Gargouille
            spellInfo->EffectTriggerSpell[0] = 61777;
        ...
        case 76838: // Mastery: Strikes of Opportunity
            spellInfo->EffectBasePoints[0] = 17.6;
            count++;
            break;
        // Priest
        ...
        case 77484: // Mastery: Shield Discipline
            ...
            count++;
            break;
        case 77486: // Mastery: Shadow Orb Power
            spellInfo->EffectBasePoints[0] = 11.6;
            count++;
            break;
        // Death knight
        ...
        case 76803: // Mastery: Potent Poisons
            spellInfo->EffectBasePoints[0] = 28;
            count++;
            break;
        ...
        case 76659: // Mastery: Wild Quiver
            spellInfo->EffectBasePoints[0] = 16.8;
            count++;
            break;
        case 76657: // Mastery: Master of Beasts
            spellInfo->EffectBasePoints[0] = 13.36;
            count++;
            break;
        ...
        case 3286:
            ...
            count++;
            break;
         // Holy Word: Sanctuary 3yd Dummy
         case 88667:
             spellInfo->EffectRadiusIndex[0] = 15;
             spellInfo->DurationIndex = 85;
             count++;
             break; 
         // Holy Word: Sanctuary 3yd Heal
         case 88668:
             spellInfo->EffectRadiusIndex[0] = 15;
             count++;
             break;
         // Holy Word: Sanctuary 6yd Dummy
         // Holy Word: Sanctuary 6yd Heal
         case 88685:
         case 88686:
             spellInfo->EffectRadiusIndex[0] = 28;
             count++;
             break;
         // Efflorescence 6yd Dummy
         // Efflorescence 6yd Heal
         case 81262:
         case 81269:
             spellInfo->EffectRadiusIndex[0] = 28;
             count++;
        ...
        case 82935: case 88916: case 88915: case 88917:     // Caustic Slime
        ...
        case 93710:                             // Asphyxiate Heroic
            spellInfo->EffectRadiusIndex[0] = 120; // (100)
        ...
        case 95173:                             // Consuming Darkness (H)
            ...
            break;
        case 82848:                             // Massacre
            spellInfo->EffectRadiusIndex[0] = 450; // (90m)
            count++;
            break;
        case 77760:                             // Biting Chill
        case 78208:                             // Absolute Zero
        case 79889:                             // Lightning conductor
            spellInfo->EffectRadiusIndex[0] = 15; // (3m)
            count++;
            break;
        case 83692:                             // Eruption
            spellInfo->EffectRadiusIndex[0] = 20; // (4m)
            count++;
            break;
        case 77699: case 92979: case 92978: case 92980:    // Flash Freeze
            spellInfo->EffectRadiusIndex[0] = 25; // (5m)
            count++;
            break;
        case 86013:                             // Twilight Meteorite
            spellInfo->EffectRadiusIndex[0] = 30; // (6m)
            mSpellCustomAttr[i] |= SPELL_ATTR0_CU_SHARE_DAMAGE;
            count++;
            break;
        ...
        case 83578:                             // Gravity Well
            spellInfo->EffectRadiusIndex[0] = 35; // (7m)
            count++;
            break;
        case 86369:                             // Twilight Blast
        case 86788:                             // Blackout
        case 86305:                             // Unstable Twilight
        case 84913:                             // Lava Seed
        case 92481:                             // Electric Instability
        case 72081:                             // Frozen Orb
        case 52658:                             // Static Overload
        case 82746:                             // Glaciate
            spellInfo->EffectRadiusIndex[0] = 40; // (8m)
            count++;
            break;
        case 81685: case 93179: case 93178: case 93180:     // Corrupting Crash
        case 81757:                             // Spilled Blood of the Old God
        case 79339:                             // Explosive Cinders
        case 93130:                             // Ice Patch
        case 86281:                             // Toxic Spores
            spellInfo->EffectRadiusIndex[0] = 50; // (10m)
            count++;
            break;
        case 86408:                             // Dazzling Destruction
            spellInfo->EffectRadiusIndex[0] = 60; // (12m)
            count++;
            break;
        case 91879:                             // Arcane Blowback
            spellInfo->EffectRadiusIndex[0] = 85; // (17m)
            count++;
            break;
        case 82777:                             // Flame Torrent
            spellInfo->EffectRadiusIndex[0] = 90; // (18m)
            count++;
            break;
        case 78225: // Acid Nova 10N
            spellInfo->EffectRadiusIndex[0] = 80;
            count++;
            break;
        case 93012: // Acid Nova 10H
            spellInfo->EffectRadiusIndex[0] = 80;
            count++;
            break;
        case 93011: // Acid Nova 25N
            spellInfo->EffectRadiusIndex[0] = 80;
            count++;
            break;
        case 93013: // Acid Nova 25H
            spellInfo->EffectRadiusIndex[0] = 80;
            count++;
            break;
        case 78095: // Magma Jets
        case 78124: // Magma Jets
            spellInfo->EffectRadiusIndex[0] = 15; // (3)
            count++;
            break;
        case 77908: // Arcane storm
            spellInfo->EffectRadiusIndex[0] = 80;
            count++;
            break;
        case 77826:                             // Shadowflame Breath
        case 77832:                             // ightning Discharge
        case 93059:                             // Storm Shield
            spellInfo->EffectRadiusIndex[0] = 300; // (60m)
            count++;
            break;
        case 94089:                             // Electrocute
        case 80735:                             // Blast Nova
        case 78999:                             // Electrical Overload
        case 79023:                             // Incineration Security Measure
        case 79504:                             // Flamethrower
        case 93124:                             // Wind Chill
        case 86081:                             // Permafrost
        case 84638:                             // Zephyr
            spellInfo->EffectRadiusIndex[0] = 450; // (90m)
            count++;
            break;
        case 78115:                             // Sonic Fireball
            spellInfo->EffectRadiusIndex[0] = 250000; // (50000m)
            count++;
            break;
