...
void AddSC_mob_trash_scarlet_monastery();    // TrashOld
...
void AddSC_boss_ignis();                 //Ulduar Ulduar
...
void AddSC_boss_magmaw();               // Boss Desente de Aile Noir
...
void AddSC_boss_halfus_wyrmbreaker();   // Boss Bastion Twilight
void AddSC_mob_trash_chogall();
void AddSC_instance_the_bastion_of_twilight();
void AddSC_throne_of_the_four_winds();  // Boss Trone Of Four Winds
void AddSC_boss_conclave_of_wind();
void AddSC_instance_throne_of_the_four_winds();
void AddSC_boss_commander_ulthok();     // Boss Trone des Marée
...
void AddSC_boss_belle();                // Boss Caverne Rochenoire
void AddSC_boss_romogg_bonecrusher();
void AddSC_boss_ascendant_lord_obsidius();
void AddSC_boss_corla_herald_of_twilight();
void AddSC_boss_karsh_steelbender();
void AddSC_instance_blackrock_caverns();
void AddSC_boss_altairus();             // Boss Cime du Vortex
...
void AddSC_boss_setesh();               // Boss Salle des Origines
...
void AddSC_boss_siamat();               // Boss TolVir
void AddSC_boss_high_prophet_barim();
void AddSC_boss_general_husam();
void AddSC_boss_lockmaw();
void AddSC_lost_city_of_the_tolvir();
void AddSC_instance_lost_city_of_the_tolvir();
void AddSC_boss_corborus();             // Boss Coeur de Pierre
void AddSC_boss_ozruk();
void AddSC_boss_slabhide();
void AddSC_boss_azil();
void AddSC_the_stonecore();
void AddSC_instance_the_stonecore();
void AddSC_boss_baron_ashbury();        // Boss Ombrecroc
...
void AddSC_mob_trash_trone_des_marees(); // trash Mobs
...
void AddEasternKingdomsScripts()
{
    ...
    AddSC_boss_kirthonos_le_herault();
...
void AddNorthrendScripts()
{
    ...
    AddSC_boss_ignis();                 //Ulduar Ulduar
    ...
    AddSC_boss_argaloth();
    AddSC_boss_magmaw();               // Boss Desente de Aile Noir
    ...
    AddSC_boss_halfus_wyrmbreaker();   // Boss Bastion Twilight
    AddSC_mob_trash_chogall();
    AddSC_instance_the_bastion_of_twilight();
    AddSC_throne_of_the_four_winds();  // Boss Trone Of Four Winds
    AddSC_boss_conclave_of_wind();
    AddSC_instance_throne_of_the_four_winds();
    AddSC_boss_commander_ulthok();     // Boss Trone des Maree
    ...
    AddSC_boss_belle();                // Boss Caverne Rochenoire
...
// Custom
    ...
    AddSC_mob_trash_scarlet_monastery();    // TrashOld
    AddSC_mob_trash_razorfen_kraul();
    AddSC_mob_profondeur_de_brassenoire();
    AddSC_mob_trash_gnomeregan();
