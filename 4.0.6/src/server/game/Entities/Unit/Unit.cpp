    ...
    switch(dummySpell->SpellFamilyName)
    {
        ...
        case SPELLFAMILY_DEATHKNIGHT:
        {
            ...
            if (dummySpell->Id == 49028)
            {
                ...
                {
                    pet->SendSpellNonMeleeDamageLog(pet->getVictim(), procSpell->Id, damage, GetSpellSchoolMask(procSpell), 0, 0, false, 0, false); 
                        pet->DealDamage(pet->getVictim(), damage, NULL, SPELL_DIRECT_DAMAGE, GetSpellSchoolMask(procSpell), procSpell, true);
                }
                else
                    return false;
            }
