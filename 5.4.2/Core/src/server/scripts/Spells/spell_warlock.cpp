...
* Scriptnames of files in this file should be prefixed with "spell_warlock_".
*/
...
// 710 - Banish
/// Updated 4.3.4
class spell_warlock_banish : public SpellScriptLoader
{
public:
    spell_warlock_banish() : SpellScriptLoader("spell_warlock_banish") { }

    class spell_warlock_banish_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_warlock_banish_SpellScript);
        ...
        void Register()
        {
            BeforeHit += SpellHitFn(spell_warlock_banish_SpellScript::HandleBanish);
            AfterHit += SpellHitFn(spell_warlock_banish_SpellScript::RemoveAura);
        }
    ...
    {
        return new spell_warlock_banish_SpellScript();
    }
};
...
public:
    ...
    class spell_warlock_create_healthstone_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnEffectHitTarget += SpellEffectFn(spell_warlock_create_healthstone_SpellScript::HandleScriptEffect, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
            OnCheckCast += SpellCheckCastFn(spell_warlock_create_healthstone_SpellScript::CheckCast);
        }
    };
...
//6262 - Use HeathStone
class spell_warlock_use_healthstone : public SpellScriptLoader
{
public:
    spell_warlock_use_healthstone() : SpellScriptLoader("spell_warlock_use_healthstone") { }

    class spell_warlock_use_healthstone_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_warlock_use_healthstone_SpellScript);
        ...
        void Register()
        {
            OnHit += SpellHitFn(spell_warlock_use_healthstone_SpellScript::HandleHeal);
        }
    };

    class spell_warlock_use_healthstone_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_warlock_use_healthstone_AuraScript);
        ...
        void Register()
        {
            OnEffectApply += AuraEffectRemoveFn(spell_warlock_use_healthstone_AuraScript::OnPeriodicHeal, EFFECT_1, SPELL_AURA_PERIODIC_HEAL, AURA_EFFECT_HANDLE_REAL);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_warlock_use_healthstone_AuraScript();
    }

    SpellScript* GetSpellScript() const
    {
        return new spell_warlock_use_healthstone_SpellScript();
    }
};

// 603 - Bane of Doom
/// Updated 4.3.4
class spell_warlock_bane_of_doom : public SpellScriptLoader
{
public:
    spell_warlock_bane_of_doom() : SpellScriptLoader("spell_warlock_bane_of_doom") { }

    class spell_warlock_curse_of_doom_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_warlock_curse_of_doom_AuraScript);
        ...
        void Register()
        {
            AfterEffectRemove += AuraEffectRemoveFn(spell_warlock_curse_of_doom_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_PERIODIC_DAMAGE, AURA_EFFECT_HANDLE_REAL);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_warlock_curse_of_doom_AuraScript();
    }
};

// 48018 - Demonic Circle: Summon
/// Updated 4.3.4
class spell_warlock_demonic_circle_summon : public SpellScriptLoader
{
public:
    spell_warlock_demonic_circle_summon() : SpellScriptLoader("spell_warlock_demonic_circle_summon") { }

    class spell_warlock_demonic_circle_summon_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_warlock_demonic_circle_summon_AuraScript);
        ...
        void Register()
        {
            OnEffectRemove += AuraEffectApplyFn(spell_warlock_demonic_circle_summon_AuraScript::HandleRemove, EFFECT_0, SPELL_AURA_PERIODIC_DUMMY, AURA_EFFECT_HANDLE_REAL_OR_REAPPLY_MASK);
            OnEffectPeriodic += AuraEffectPeriodicFn(spell_warlock_demonic_circle_summon_AuraScript::HandleDummyTick, EFFECT_0, SPELL_AURA_PERIODIC_DUMMY);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_warlock_demonic_circle_summon_AuraScript();
    }
};

// 48020 - Demonic Circle: Teleport
/// Updated 4.3.4
class spell_warlock_demonic_circle_teleport : public SpellScriptLoader
{
public:
    spell_warlock_demonic_circle_teleport() : SpellScriptLoader("spell_warlock_demonic_circle_teleport") { }

    class spell_warlock_demonic_circle_teleport_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_warlock_demonic_circle_teleport_AuraScript);
        ...
        void Register()
        {
            OnEffectApply += AuraEffectApplyFn(spell_warlock_demonic_circle_teleport_AuraScript::HandleTeleport, EFFECT_0, SPELL_AURA_MECHANIC_IMMUNITY, AURA_EFFECT_HANDLE_REAL);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_warlock_demonic_circle_teleport_AuraScript();
    }
};

// 77801 - Demon Soul - Updated to 4.3.4
class spell_warlock_demon_soul : public SpellScriptLoader
{
public:
    spell_warlock_demon_soul() : SpellScriptLoader("spell_warlock_demon_soul") { }

    class spell_warlock_demon_soul_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_warlock_demon_soul_SpellScript);
        ...
        void Register()
        {
            OnEffectHitTarget += SpellEffectFn(spell_warlock_demon_soul_SpellScript::OnHitTarget, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_warlock_demon_soul_SpellScript;
    }
};
...
public:
    ...
    class spell_warlock_demonic_empowerment_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnEffectHitTarget += SpellEffectFn(spell_warlock_demonic_empowerment_SpellScript::HandleScriptEffect, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
        }
    };
...
/// Updated 4.3.4
class spell_warlock_everlasting_affliction : public SpellScriptLoader
{
public:
    spell_warlock_everlasting_affliction() : SpellScriptLoader("spell_warlock_everlasting_affliction") { }

    class spell_warlock_everlasting_affliction_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_warlock_everlasting_affliction_SpellScript);
        ...
        void Register()
        {
            OnEffectHitTarget += SpellEffectFn(spell_warlock_everlasting_affliction_SpellScript::HandleScriptEffect, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_warlock_everlasting_affliction_SpellScript();
    }
};

// 77799 - Fel Flame - Updated to 4.3.4
class spell_warlock_fel_flame : public SpellScriptLoader
{
public:
    spell_warlock_fel_flame() : SpellScriptLoader("spell_warlock_fel_flame") { }

    class spell_warlock_fel_flame_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_warlock_fel_flame_SpellScript);
        ...
        void Register()
        {
            OnEffectHitTarget += SpellEffectFn(spell_warlock_fel_flame_SpellScript::OnHitTarget, EFFECT_1, SPELL_EFFECT_SCRIPT_EFFECT);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_warlock_fel_flame_SpellScript;
    }
};

// -47230 - Fel Synergy
class spell_warlock_fel_synergy : public SpellScriptLoader
{
public:
    spell_warlock_fel_synergy() : SpellScriptLoader("spell_warlock_fel_synergy") { }

    class spell_warlock_fel_synergy_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_warlock_fel_synergy_AuraScript);
        ...
        void Register()
        {
            DoCheckProc += AuraCheckProcFn(spell_warlock_fel_synergy_AuraScript::CheckProc);
            OnEffectProc += AuraEffectProcFn(spell_warlock_fel_synergy_AuraScript::OnProc, EFFECT_0, SPELL_AURA_DUMMY);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_warlock_fel_synergy_AuraScript();
    }
};
...
public:
    ...
    class spell_warlock_haunt_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_warlock_haunt_SpellScript);
        ...
        void Register()
        {
            OnHit += SpellHitFn(spell_warlock_haunt_SpellScript::HandleOnHit);
        }
    };
    ...
    class spell_warlock_haunt_AuraScript : public AuraScript
    {
        ...
        void Register()
        {
            OnEffectRemove += AuraEffectApplyFn(spell_warlock_haunt_AuraScript::HandleRemove, EFFECT_1, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL_OR_REAPPLY_MASK);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_warlock_haunt_SpellScript();
    }
...
// 755 - Health Funnel
/// Updated 4.3.4
class spell_warlock_health_funnel : public SpellScriptLoader
{
public:
    spell_warlock_health_funnel() : SpellScriptLoader("spell_warlock_health_funnel") { }

    class spell_warlock_health_funnel_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_warlock_health_funnel_AuraScript);
        ...
        void Register()
        {
            OnEffectRemove += AuraEffectRemoveFn(spell_warlock_health_funnel_AuraScript::RemoveEffect, EFFECT_0, SPELL_AURA_PERIODIC_HEAL, AURA_EFFECT_HANDLE_REAL);
            OnEffectApply += AuraEffectApplyFn(spell_warlock_health_funnel_AuraScript::ApplyEffect, EFFECT_0, SPELL_AURA_PERIODIC_HEAL, AURA_EFFECT_HANDLE_REAL);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_warlock_health_funnel_AuraScript();
    }
};
...
public:
    ...
    class spell_warlock_life_tap_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnCheckCast += SpellCheckCastFn(spell_warlock_life_tap_SpellScript::CheckLife);
            OnHit += SpellHitFn(spell_warlock_life_tap_SpellScript::HandleOnHit);
        }
    };
...
class spell_warlock_ritual_of_doom_effect : public SpellScriptLoader
{
public:
    spell_warlock_ritual_of_doom_effect() : SpellScriptLoader("spell_warlock_ritual_of_doom_effect") { }

    class spell_warlock_ritual_of_doom_effect_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_warlock_ritual_of_doom_effect_SpellScript);
        ...
        void Register()
        {
            OnEffectHit += SpellEffectFn(spell_warlock_ritual_of_doom_effect_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_warlock_ritual_of_doom_effect_SpellScript();
    }
};
...
public:
    ...
    class spell_warlock_seed_of_corruption_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_warlock_seed_of_corruption_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_DEST_AREA_ENEMY);
        }
    };
...
// -7235 - Shadow Ward
class spell_warlock_shadow_ward : public SpellScriptLoader
{
public:
    spell_warlock_shadow_ward() : SpellScriptLoader("spell_warlock_shadow_ward") { }

    class spell_warlock_shadow_ward_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_warlock_shadow_ward_AuraScript);
        ...
        void Register()
        {
            DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_warlock_shadow_ward_AuraScript::CalculateAmount, EFFECT_0, SPELL_AURA_SCHOOL_ABSORB);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_warlock_shadow_ward_AuraScript();
    }
};
...
public:
    ...
    class spell_warlock_siphon_life_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_warlock_siphon_life_AuraScript);
        ...
        void Register()
        {
            DoCheckProc += AuraCheckProcFn(spell_warlock_siphon_life_AuraScript::CheckProc);
            OnEffectProc += AuraEffectProcFn(spell_warlock_siphon_life_AuraScript::OnProc, EFFECT_0, SPELL_AURA_DUMMY);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_warlock_siphon_life_AuraScript();
    }
};

// 29858 - Soulshatter
/// Updated 4.3.4
class spell_warlock_soulshatter : public SpellScriptLoader
{
public:
    spell_warlock_soulshatter() : SpellScriptLoader("spell_warlock_soulshatter") { }

    class spell_warlock_soulshatter_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_warlock_soulshatter_SpellScript);
        ...
        void Register()
        {
            OnEffectHitTarget += SpellEffectFn(spell_warlock_soulshatter_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_warlock_soulshatter_SpellScript();
    }
};
...
public:
    ...
    class spell_warlock_unstable_affliction_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_warlock_unstable_affliction_AuraScript);
        ...
        void Register()
        {
            AfterDispel += AuraDispelFn(spell_warlock_unstable_affliction_AuraScript::HandleDispel);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_warlock_unstable_affliction_AuraScript();
    }
};

// Kil'Jaeden's Cunning (passive with cooldown) - 119048
class spell_warlock_kil_jaedens_cunning : public SpellScriptLoader
{
public:
    spell_warlock_kil_jaedens_cunning() : SpellScriptLoader("spell_warlock_kil_jaedens_cunning") { }

    class spell_warlock_kil_jaedens_cunning_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_warlock_kil_jaedens_cunning_AuraScript);
        ...
        void Register()
        {
            OnEffectApply += AuraEffectApplyFn(spell_warlock_kil_jaedens_cunning_AuraScript::HandleApply, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            OnEffectRemove += AuraEffectRemoveFn(spell_warlock_kil_jaedens_cunning_AuraScript::HandleRemove, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_warlock_kil_jaedens_cunning_AuraScript();
    }
};
...
public:
    ...
    class spell_warlock_burning_rush_AuraScript : public AuraScript
    {
        ...
        void Register()
        {
            OnEffectPeriodic += AuraEffectPeriodicFn(spell_warlock_burning_rush_AuraScript::OnTick, EFFECT_1, SPELL_AURA_PERIODIC_DUMMY);
        }
    };
...
// Harvest Life - 108371
class spell_warlock_harvest_life : public SpellScriptLoader
{
public:
    spell_warlock_harvest_life() : SpellScriptLoader("spell_warlock_harvest_life") { }

    class spell_warlock_harvest_life_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_warlock_harvest_life_AuraScript);
        ...
        void Register()
        {
            OnEffectPeriodic += AuraEffectPeriodicFn(spell_warlock_harvest_life_AuraScript::OnTick, EFFECT_2, SPELL_AURA_PERIODIC_DAMAGE);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_warlock_harvest_life_AuraScript();
    }
};
...
public:
    ...
    class spell_warlock_grimoire_of_sacrifice_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            AfterCast += SpellCastFn(spell_warlock_grimoire_of_sacrifice_SpellScript::HandleAfterCast);
            OnHit += SpellHitFn(spell_warlock_grimoire_of_sacrifice_SpellScript::HandleOnHit);
        }
    };
    ...
    class spell_warlock_grimoire_of_sacrifice_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_warlock_grimoire_of_sacrifice_AuraScript);
        ...
        void Register()
        {
            OnEffectRemove += AuraEffectApplyFn(spell_warlock_grimoire_of_sacrifice_AuraScript::HandleRemove, EFFECT_1, SPELL_AURA_OBS_MOD_HEALTH, AURA_EFFECT_HANDLE_REAL);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_warlock_grimoire_of_sacrifice_AuraScript();
    }
};


// Burning Embers - 108647
class spell_warlock_burning_embers : public SpellScriptLoader
{
public:
    spell_warlock_burning_embers() : SpellScriptLoader("spell_warlock_burning_embers") { }

    class spell_warlock_burning_embers_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_warlock_burning_embers_AuraScript);
        ...
        void Register()
        {
            OnProc += AuraProcFn(spell_warlock_burning_embers_AuraScript::OnProcHandler);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_warlock_burning_embers_AuraScript();
    }
};
...
public:
    ...
    class spell_warlock_drain_life_AuraScript : public AuraScript
    {
        ...
        void Register()
        {
            OnEffectPeriodic += AuraEffectPeriodicFn(spell_warlock_drain_life_AuraScript::OnTick, EFFECT_0, SPELL_AURA_PERIODIC_DAMAGE);
        }
    };
...
class spell_warlock_soulburn_drain_life : public SpellScriptLoader
{
public:
    spell_warlock_soulburn_drain_life() : SpellScriptLoader("spell_warlock_soulburn_drain_life") { }

    class spell_warlock_soulburn_drain_life_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_warlock_soulburn_drain_life_AuraScript);
        ...
        void Register()
        {
            OnEffectApply += AuraEffectApplyFn(spell_warlock_soulburn_drain_life_AuraScript::HandleApply, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            OnEffectPeriodic += AuraEffectPeriodicFn(spell_warlock_soulburn_drain_life_AuraScript::OnTick, EFFECT_0, SPELL_AURA_PERIODIC_DAMAGE);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_warlock_soulburn_drain_life_AuraScript();
    }
};

// Called by Shadowflame - 47960
// Molten Core - 122351
class spell_warlock_molten_core_dot : public SpellScriptLoader
{
public:
    spell_warlock_molten_core_dot() : SpellScriptLoader("spell_warlock_molten_core_dot") { }

    class spell_warlock_molten_core_dot_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_warlock_molten_core_dot_AuraScript);
        ...
        void Register()
        {
            OnEffectPeriodic += AuraEffectPeriodicFn(spell_warlock_molten_core_dot_AuraScript::OnTick, EFFECT_0, SPELL_AURA_PERIODIC_DAMAGE);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_warlock_molten_core_dot_AuraScript();
    }
};

// Called by Shadow Bolt - 686 and Soul Fire - 6353
// Decimate - 108869
class spell_warlock_decimate : public SpellScriptLoader
{
public:
    spell_warlock_decimate() : SpellScriptLoader("spell_warlock_decimate") { }

    class spell_warlock_decimate_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_warlock_decimate_SpellScript);
        ...
        void Register()
        {
            OnHit += SpellHitFn(spell_warlock_decimate_SpellScript::HandleOnHit);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_warlock_decimate_SpellScript();
    }
};

// Metamorphosis - 103958
class spell_warlock_metamorphosis_cost : public SpellScriptLoader
{
public:
    spell_warlock_metamorphosis_cost() : SpellScriptLoader("spell_warlock_metamorphosis_cost") { }

    class spell_warlock_metamorphosis_cost_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_warlock_metamorphosis_cost_AuraScript);
        ...
        void Register()
        {
            OnEffectPeriodic += AuraEffectPeriodicFn(spell_warlock_metamorphosis_cost_AuraScript::OnTick, EFFECT_2, SPELL_AURA_PERIODIC_DUMMY);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_warlock_metamorphosis_cost_AuraScript();
    }
};
...
public:
    ...
    class spell_warlock_immolation_aura_AuraScript : public AuraScript
    {
        ...
        void Register()
        {
            OnEffectPeriodic += AuraEffectPeriodicFn(spell_warlock_immolation_aura_AuraScript::OnTick, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL);
        }
    };
...
// Hellfire - 5857
class spell_warlock_hellfire : public SpellScriptLoader
{
public:
    spell_warlock_hellfire() : SpellScriptLoader("spell_warlock_hellfire") { }

    class spell_warlock_hellfire_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_warlock_hellfire_SpellScript);
        ...
        void Register()
        {
            OnHit += SpellHitFn(spell_warlock_hellfire_SpellScript::HandleOnHit);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_warlock_hellfire_SpellScript();
    }
};

// 108686 - Immolate effect for WARLOCK_FIRE_AND_BRIMSTONE
class spell_warlock_immolate : public SpellScriptLoader
{
public:
    spell_warlock_immolate() : SpellScriptLoader("spell_warlock_immolate") { }

    class spell_warlock_immolate_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_warlock_immolate_SpellScript);
        ...
        void Register()
        {
            OnHit += SpellHitFn(spell_warlock_immolate_SpellScript::HandleOnHit);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_warlock_immolate_SpellScript();
    }
};
...
public:
    ...
    class spell_warlock_incinerate_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnHit += SpellHitFn(spell_warlock_incinerate_SpellScript::HandleOnHit);
        }
    };
...
class spell_warlock_conflagrate_and_brimstone : public SpellScriptLoader
{
public:
    spell_warlock_conflagrate_and_brimstone() : SpellScriptLoader("spell_warlock_conflagrate_and_brimstone") { }

    class spell_warlock_conflagrate_and_brimstone_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_warlock_conflagrate_and_brimstone_SpellScript);
        ...
        void Register()
        {
            OnHit += SpellHitFn(spell_warlock_conflagrate_and_brimstone_SpellScript::HandleOnHit);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_warlock_conflagrate_and_brimstone_SpellScript();
    }
};
...
public:
    ...
    class spell_warlock_chaos_bolt_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            AfterCast += SpellCastFn(spell_warlock_chaos_bolt_SpellScript::HandleAfterCast);
        }
    };
...
class spell_warlock_grimoire_of_supremacy : public SpellScriptLoader
{
public:
    spell_warlock_grimoire_of_supremacy() : SpellScriptLoader("spell_warlock_grimoire_of_supremacy") { }

    class spell_warlock_grimoire_of_supremacy_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_warlock_grimoire_of_supremacy_AuraScript);
        ...
        void Register()
        {
            OnEffectApply += AuraEffectApplyFn(spell_warlock_grimoire_of_supremacy_AuraScript::OnApply, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            OnEffectRemove += AuraEffectRemoveFn(spell_warlock_grimoire_of_supremacy_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_warlock_grimoire_of_supremacy_AuraScript();
    }
};

void AddSC_warlock_spell_scripts()
{
    new spell_warlock_bane_of_doom();
    new spell_warlock_banish();
    new spell_warlock_conflagrate();
    new spell_warlock_create_healthstone();
    new spell_warlock_use_healthstone();
    new spell_warlock_demonic_circle_summon();
    new spell_warlock_demonic_circle_teleport();
    new spell_warlock_demonic_empowerment();
    new spell_warlock_demon_soul();
    new spell_warlock_everlasting_affliction();
    new spell_warlock_fel_flame();
    new spell_warlock_fel_synergy();
    new spell_warlock_haunt();
    new spell_warlock_health_funnel();
    new spell_warlock_life_tap();
    new spell_warlock_ritual_of_doom_effect();
    new spell_warlock_seed_of_corruption();
    new spell_warlock_shadow_ward();
    new spell_warlock_siphon_life();
    new spell_warlock_soulshatter();
    new spell_warlock_unstable_affliction();
    new spell_warlock_kil_jaedens_cunning();
    new spell_warlock_burning_rush();
    new spell_warlock_harvest_life();
    new spell_warlock_grimoire_of_sacrifice();
    new spell_warlock_burning_embers();
    new spell_warlock_drain_life();
    new spell_warlock_soulburn_drain_life();
    new spell_warlock_molten_core_dot();
    new spell_warlock_decimate();
    new spell_warlock_metamorphosis_cost();
    new spell_warlock_immolation_aura();
    new spell_warlock_hellfire();
    new spell_warlock_immolate();
    new spell_warlock_incinerate();
    new spell_warlock_conflagrate_and_brimstone();
    new spell_warlock_chaos_bolt();
    new spell_warlock_grimoire_of_supremacy();
}
