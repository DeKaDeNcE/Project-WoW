...
class spell_warlock_pet_scaling_01 : public SpellScriptLoader
{
public:
    spell_warlock_pet_scaling_01() : SpellScriptLoader("spell_warlock_pet_scaling_01") { }

    class spell_warlock_pet_scaling_01_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_warlock_pet_scaling_01_AuraScript);
        ...
        void Register()
        {
            OnEffectRemove += AuraEffectRemoveFn(spell_warlock_pet_scaling_01_AuraScript::RemoveEffect, EFFECT_0, SPELL_AURA_MOD_STAT, AURA_EFFECT_HANDLE_CHANGE_AMOUNT_MASK);
            AfterEffectApply += AuraEffectApplyFn(spell_warlock_pet_scaling_01_AuraScript::ApplyEffect, EFFECT_0, SPELL_AURA_MOD_STAT, AURA_EFFECT_HANDLE_CHANGE_AMOUNT_MASK);
            DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_warlock_pet_scaling_01_AuraScript::CalculateStaminaAmount, EFFECT_0, SPELL_AURA_MOD_STAT);
            DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_warlock_pet_scaling_01_AuraScript::CalculateAttackPowerAmount, EFFECT_1, SPELL_AURA_MOD_ATTACK_POWER);
            DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_warlock_pet_scaling_01_AuraScript::CalculateDamageDoneAmount, EFFECT_2, SPELL_AURA_MOD_DAMAGE_DONE);
        }
    ...
    AuraScript* GetAuraScript() const
    {
        return new spell_warlock_pet_scaling_01_AuraScript();
    }
};

class spell_warlock_pet_scaling_02 : public SpellScriptLoader
{
public:
    spell_warlock_pet_scaling_02() : SpellScriptLoader("spell_warlock_pet_scaling_02") { }

    class spell_warlock_pet_scaling_02_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_warlock_pet_scaling_02_AuraScript);
        ...
        void Register()
        {
            OnEffectRemove += AuraEffectRemoveFn(spell_warlock_pet_scaling_02_AuraScript::RemoveEffect, EFFECT_0, SPELL_AURA_MOD_STAT, AURA_EFFECT_HANDLE_CHANGE_AMOUNT_MASK);
            AfterEffectApply += AuraEffectApplyFn(spell_warlock_pet_scaling_02_AuraScript::ApplyEffect, EFFECT_0, SPELL_AURA_MOD_STAT, AURA_EFFECT_HANDLE_CHANGE_AMOUNT_MASK);
            DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_warlock_pet_scaling_02_AuraScript::CalculateIntellectAmount, EFFECT_0, SPELL_AURA_MOD_STAT);
            DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_warlock_pet_scaling_02_AuraScript::CalculateArmorAmount, EFFECT_1, SPELL_AURA_MOD_RESISTANCE);
            DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_warlock_pet_scaling_02_AuraScript::CalculateFireResistanceAmount, EFFECT_2, SPELL_AURA_MOD_RESISTANCE);
        }
    ...
    AuraScript* GetAuraScript() const
    {
        return new spell_warlock_pet_scaling_02_AuraScript();
    }
};

class spell_warlock_pet_scaling_03 : public SpellScriptLoader
{
public:
    spell_warlock_pet_scaling_03() : SpellScriptLoader("spell_warlock_pet_scaling_03") { }

    class spell_warlock_pet_scaling_03_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_warlock_pet_scaling_03_AuraScript);
        ...
        void Register()
        {
            DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_warlock_pet_scaling_03_AuraScript::CalculateFrostResistanceAmount, EFFECT_0, SPELL_AURA_MOD_RESISTANCE);
            DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_warlock_pet_scaling_03_AuraScript::CalculateArcaneResistanceAmount, EFFECT_1, SPELL_AURA_MOD_RESISTANCE);
            DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_warlock_pet_scaling_03_AuraScript::CalculateNatureResistanceAmount, EFFECT_2, SPELL_AURA_MOD_RESISTANCE);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_warlock_pet_scaling_03_AuraScript();
    }
};


class spell_warlock_pet_scaling_04 : public SpellScriptLoader
{
public:
    spell_warlock_pet_scaling_04() : SpellScriptLoader("spell_warlock_pet_scaling_04") { }

    class spell_warlock_pet_scaling_04_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_warlock_pet_scaling_04_AuraScript);
        ...
        void Register()
        {
            DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_warlock_pet_scaling_04_AuraScript::CalculateShadowResistanceAmount, EFFECT_0, SPELL_AURA_MOD_RESISTANCE);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_warlock_pet_scaling_04_AuraScript();
    }
};

class spell_warlock_pet_scaling_05 : public SpellScriptLoader
{
public:
    spell_warlock_pet_scaling_05() : SpellScriptLoader("spell_warlock_pet_scaling_05") { }

    class spell_warlock_pet_scaling_05_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_warlock_pet_scaling_05_AuraScript);
        ...
        void Register()
        {
            DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_warlock_pet_scaling_05_AuraScript::CalculateAmountMeleeHit, EFFECT_0, SPELL_AURA_MOD_HIT_CHANCE);
            DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_warlock_pet_scaling_05_AuraScript::CalculateAmountSpellHit, EFFECT_1, SPELL_AURA_MOD_SPELL_HIT_CHANCE);
            DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_warlock_pet_scaling_05_AuraScript::CalculateAmountExpertise, EFFECT_2, SPELL_AURA_MOD_EXPERTISE);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_warlock_pet_scaling_05_AuraScript();
    }
};

class spell_warlock_pet_passive : public SpellScriptLoader
{
public:
    spell_warlock_pet_passive() : SpellScriptLoader("spell_warlock_pet_passive") { }

    class spell_warlock_pet_passive_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_warlock_pet_passive_AuraScript);
        ...
        void Register()
        {
            DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_warlock_pet_passive_AuraScript::CalculateAmountCritSpell, EFFECT_0, SPELL_AURA_MOD_SPELL_CRIT_CHANCE);
            DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_warlock_pet_passive_AuraScript::CalculateAmountCritMelee, EFFECT_1, SPELL_AURA_MOD_WEAPON_CRIT_PERCENT);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_warlock_pet_passive_AuraScript();
    }
};
// this doesnt actually fit in here
class spell_warlock_pet_passive_damage_done : public SpellScriptLoader
{
public:
    spell_warlock_pet_passive_damage_done() : SpellScriptLoader("spell_warlock_pet_passive_damage_done") { }

    class spell_warlock_pet_passive_damage_done_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_warlock_pet_passive_damage_done_AuraScript);
        ...
        void Register()
        {
            DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_warlock_pet_passive_damage_done_AuraScript::CalculateAmountDamageDone, EFFECT_0, SPELL_AURA_MOD_DAMAGE_PERCENT_DONE);
            DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_warlock_pet_passive_damage_done_AuraScript::CalculateAmountDamageDone, EFFECT_1, SPELL_AURA_MOD_DAMAGE_PERCENT_DONE);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_warlock_pet_passive_damage_done_AuraScript();
    }
};

class spell_warlock_pet_passive_voidwalker : public SpellScriptLoader
{
public:
    spell_warlock_pet_passive_voidwalker() : SpellScriptLoader("spell_warlock_pet_passive_voidwalker") { }

    class spell_warlock_pet_passive_voidwalker_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_warlock_pet_passive_voidwalker_AuraScript);
        ...
        void Register()
        {
            DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_warlock_pet_passive_voidwalker_AuraScript::CalculateAmount, EFFECT_0, SPELL_AURA_MOD_TOTAL_STAT_PERCENTAGE);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_warlock_pet_passive_voidwalker_AuraScript();
    }
};
